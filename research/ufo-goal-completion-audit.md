...
|---|---|---:|---|
| Full file inventory | `research/ufo-file-manifest.csv`; `170` files inventoried | Pass | None for inventory. |
...
| Images analyzed | NASA/DOS image-related records and FBI photo-set files have targeted source/provenance triage, and the Western U.S. sketch artifact has been reviewed at witness-summary level | Pass with caveat | No high-resolution pixel-level or photogrammetric review. |
| Entire collection covered | `research/ufo-file-coverage-map.csv` maps every manifest row to evidence and coverage status | Pass | Coverage map shows `0` inventory-only files across `170` manifest rows. |
...
| Professional scientific report produced | `research/ufo-final-scientific-report.md` | Pass | The report limits strongest claims to the modern operational subset while incorporating broader corpus triage. |
| Final report support verified | `research/ufo-final-report-consistency-check.md`; `50` support references, `0` missing | Pass | None for targeted whole-corpus assessment. |
...
- `research/ufo-file-coverage-map.csv`
- `research/ufo-file-coverage-summary.csv`
- `scripts/ufo_build_file_coverage_map.ps1`

Current coverage summary:

| Coverage status | Count | Interpretation |
|---|---:|---|
| `deep_review` | `33` | Dedicated source packet, review note, or deep visual analysis exists. |
...
| `partial_review` | `0` | No manifest row remains partial-review only. |
...
| NASA transcripts/images | Targeted review only | `14` |
| DOS cables | Targeted review only | `2` |
| FBI photo set | Targeted review only | `33` |
| Recent witness/sketch artifacts | Reviewed at witness-summary level | `2` |
