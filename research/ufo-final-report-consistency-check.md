...
Status: consistency check complete after publication-figure update
...
| Publication figures | `5` SVG figures generated by `scripts/generate_publication_figures.py`; all parse as valid XML |
| Figure validation | `figures/figure-validation.md` records source files and count checks |
